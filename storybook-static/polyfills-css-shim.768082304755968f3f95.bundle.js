  ...
  [1],
  {
    1305: function (module, __webpack_exports__, __webpack_require__) {
      ...
      function compileVar(e, t, r) {
        var n = (function parseVar(e, t) {
          ...
          var n = (function findVarEndIndex(e, t) {
              for (var s, r = 0, n = t; n < e.length; n++)
                if ('(' === (s = e[n])) r++
                else if (')' === s && 0 >= --r) return n + 1
              return n
            })(e, r.start),
          ...
          return {
            ...
            propName: o.trim(),
            fallback: 0 < a.length ? a.join(',').trim() : void 0,
          }
        })(e, r)
      ...
      function executeTemplate(e, t) {
        for (var s, r = '', n = 0; n < e.length; n++)
          r += 'string' == typeof (s = e[n]) ? s : s(t)
        return r
      }
      function findEndValue(e, t) {
        for (var o, r = !1, n = !1, s = t; s < e.length; s++)
          if (((o = e[s]), r))
            n && '"' === o && (r = !1), n || "'" !== o || (r = !1)
          else if ('"' === o) (r = !0), (n = !0)
          else if ("'" === o) (r = !0), (n = !1)
          ...
          .then(function (s) {
            if (
              (function hasCssVariables(e) {
                return -1 < e.indexOf('var(') || CSS_VARIABLE_REGEXP.test(e)
              })(s) &&
              r.parentNode
            ) {
                    ...
                    (function getActiveSelectors(e, t, r) {
                      var n = [],
                        s = (function getScopesForElement(e, t) {
                          for (var n, r = []; t; )
                            (n = e.get(t)) && r.push(n), (t = t.parentElement)
                          return r
                        })(t, e)
                      return (
    ...
    1311: function (module, exports, __webpack_require__) {
      var $ = __webpack_require__(4),
        lastIndexOf = __webpack_require__(1312)
      $(
    ...
    1312: function (module, exports, __webpack_require__) {
      ...
      var toIndexedObject = __webpack_require__(66),
        ...
        arrayMethodIsStrict = __webpack_require__(93),
        arrayMethodUsesToLength = __webpack_require__(53),
        min = Math.min,
...
//# sourceMappingURL=polyfills-css-shim.768082304755968f3f95.bundle.js.map
