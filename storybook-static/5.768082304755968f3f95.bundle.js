/*! For license information please see 5.768082304755968f3f95.bundle.js.LICENSE.txt */
  ...
  [5],
  {
      ...
      var _parenSuffix = ')(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)',
        ...
        processRules = function (input, ruleCallback) {
          ...
          return inputWithEscapedBlocks.escapedString.replace(
            _ruleRe,
            function () {
              var selector = 2 >= arguments.length ? void 0 : arguments[2],
                content = '',
                suffix = 4 >= arguments.length ? void 0 : arguments[4],
                contentPrefix = ''
              suffix &&
              ...
              return ''
                .concat(1 >= arguments.length ? void 0 : arguments[1])
                .concat(rule.selector)
                .concat(3 >= arguments.length ? void 0 : arguments[3])
        ...
        escapeBlocks = function (input) {
          for (
            var part,
              inputParts = input.split(_curlyRe),
              resultParts = [],
              escapedBlocks = [],
              bracketCount = 0,
              currentBlockParts = [],
            ...
            '}' === (part = inputParts[partIndex]) && bracketCount--,
              0 < bracketCount
                ? currentBlockParts.push(part)
                : (0 < currentBlockParts.length &&
        ...
        convertColonRule = function (cssText, regExp, partReplacer) {
          return cssText.replace(regExp, function () {
            for (
              var _len = arguments.length, m = Array(_len), _key = 0;
              _key < _len;
              _key++
            )
            ...
            if (m[2]) {
              for (
                var p, parts = m[2].split(','), r = [], i = 0;
                i < parts.length && (p = parts[i].trim());
                i++
              )
        ...
        colonHostContextPartReplacer = function (host, part, suffix) {
          return -1 < part.indexOf('-shadowcsshost')
        ...
        applyStrictSelectorScope = function (
          ...
          for (
            var res,
              ...
              _scopeSelectorPart = function (p) {
                var scopedP = p.trim()
                if (!scopedP) return ''
                if (-1 < p.indexOf('-shadowcsshost-no-combinator'))
                  scopedP = (function (selector, scopeSelector, hostSelector) {
                    if (
                      ...
                      return selector
                        .replace(_polyfillHostNoCombinatorRe, function (
                          _,
                          selector,
                        ) {
                          return selector.replace(/([^:]*)(:*)(.*)/, function (
                            _,
                            before,
                            colon,
                            after,
              ...
              safeContent = (function (selector) {
                ...
                return {
                  ...
                  )).replace(/(:nth-[-\w]+)(\([^)]+\))/g, function (
                    _,
                    pseudo,
                    exp,
                  ) {
                    var replaceBy = '__ph-'.concat(index, '__')
                    return placeholders.push(exp), index++, pseudo + replaceBy
                  }),
            ...
            var separator = res[1],
              ...
              scopedPart = (shouldScope =
                shouldScope ||
                -1 < _part.indexOf('-shadowcsshost-no-combinator'))
          ...
          return (
            (scopedSelector += (shouldScope =
              shouldScope || -1 < part.indexOf('-shadowcsshost-no-combinator'))
                ...
                ? (selector = (function (
                    ...
                    return selector
                      ...
                      .map(function (shallowPart) {
                        return slotSelector &&
                          -1 < shallowPart.indexOf('.' + slotSelector)
                          ? shallowPart.trim()
        ...
        scopeCssText = function (cssText, scopeId, hostScopeId, slotScopeId) {
          var slotted = (function (cssText, slotScopeId) {
            var selectors = []
            return (
              (cssText = cssText.replace(_cssColonSlottedRe, function () {
                for (
                  var _len2 = arguments.length, m = Array(_len2), _key2 = 0;
                  _key2 < _len2;
                  _key2++
                )
                ...
                if (m[2]) {
                  for (
                    var _char,
                      ...
                      suffix = m[3],
                      slottedSelector =
                        '.' + slotScopeId + ' > ' + compound + suffix,
                      prefixSelector = '',
                      i = m[4] - 1;
                    0 <= i && '}' !== (_char = m[5][i]) && ',' !== _char;
                    i--
                  )
        ...
        scopeCss = function (cssText, scopeId, commentOriginalSelector) {
          var commentsWithHash = cssText.match(_commentWithHashRe) || []
          ...
          return (
            (cssText = [scoped.cssText]
              .concat(_toConsumableArray(commentsWithHash))
              .join('\n')),
    ...
    1310: function (module, exports, __webpack_require__) {
      ...
      var $ = __webpack_require__(4),
        $trimEnd = __webpack_require__(152).end,
        FORCED = __webpack_require__(452)('trimEnd'),
        trimEnd = FORCED
          ? function trimEnd() {
              return $trimEnd(this)
            }
          : ''.trimEnd
      $(
        {target: 'String', proto: !0, forced: FORCED},
        {trimEnd: trimEnd, trimRight: trimEnd},
      )
    },
  },
])
//# sourceMappingURL=5.768082304755968f3f95.bundle.js.map
